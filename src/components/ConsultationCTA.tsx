...
export default function ConsultationCTA(): JSX.Element {
  return (
    <section className="relative overflow-hidden border-y border-paper/10 bg-navy-deep py-20 text-paper sm:py-24 lg:py-28" aria-label="Consultation call to action">
      <div className="absolute -right-24 top-1/2 h-72 w-72 -translate-y-1/2 rotate-45 border border-gold/25" aria-hidden="true" />
